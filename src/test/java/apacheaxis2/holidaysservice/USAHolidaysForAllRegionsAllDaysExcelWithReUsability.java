...
public class USAHolidaysForAllRegionsAllDaysExcelWithReUsability
{
		...
		for(int i=1;i<nour2;i++)	//No of Regions loop
		{
			...
			for(int j=1;j<nour1;j++)	//Month loop
			{
				...
				if(month.equals("Jan") || month.equals("Mar") || month.equals("May") || month.equals("Jul") || month.equals("Aug") || month.equals("Oct") || month.equals("Dec"))
				{
					...
					{
						method(sh2, nouc2, month, j, i, k, wb, x, stub);
					}
				}
	...
	public static void method(Sheet sh2,int nouc2,String month,int i,int j,int k,Workbook wb,String x,EnricoStub stub) throws Exception
	{
